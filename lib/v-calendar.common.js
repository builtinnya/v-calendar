  ...
  normalizeDate(d, config = {}) {
    ...
    if (result && patch) {
      ...
      const parts = { ...this.getDateParts(fillDate),
        ...Object(_["s" /* pick */])(this.getDateParts(result), PATCH_KEYS[patch])
      };
  ...
  methods: {
    ...
    normalizeValue(value, config, patch, sortRange) {
      ...
      if (this.isRange) {
        ...
        result.start = this.normalizeDate(value.start, { ...startConfig,
        ...
        result.end = this.normalizeDate(value.end, { ...endConfig,
