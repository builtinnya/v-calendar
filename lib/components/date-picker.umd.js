...
var locale_Locale = /*#__PURE__*/function () {
  function Locale(config) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        ...
        locales = _ref$locales === void 0 ? defaults_locales : _ref$locales,
  ...
  _createClass(Locale, [{
    ...
    value: function normalizeDate(d) {
      ...
      if (result && patch) {
        ...
        var parts = _objectSpread2(_objectSpread2({}, this.getDateParts(fillDate)), pick_default()(this.getDateParts(result), PATCH_KEYS[patch]));
...
var attribute_Attribute = /*#__PURE__*/function () {
  function Attribute(_ref, theme, locale) {
    ...
    this.hasDates = !!helpers_arrayHasItems(this.dates); // Assign exclude dates
...
/* harmony default export */ var CalendarDayvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    refreshPopovers: function refreshPopovers() {
      ...
      if (helpers_arrayHasItems(this.popovers)) {
        popoverEvents = getPopoverTriggerEvents(defaults_default.a.apply(void 0, [{
...
/* harmony default export */ var Calendarvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    return h('div', {
      ...
      key: helpers_arrayHasItems(this.pages) ? this.pages[0].key : ''
    }, panes)]), h('div', {
  ...
  mounted: function mounted() {
    ...
    if (!this.disablePageSwipe) {
      ...
      var removeHandlers = touch_addHorizontalSwipeHandler(this.$refs.container, function (_ref3) {
  ...
  methods: {
    ...
    normalizeValue: function normalizeValue(value, config, patch, sortRange) {
      ...
      if (this.isRange) {
        ...
        result.start = this.normalizeDate(value.start, _objectSpread2(_objectSpread2({}, startConfig), {}, {
        ...
        result.end = this.normalizeDate(value.end, _objectSpread2(_objectSpread2({}, endConfig), {}, {
    ...
    showPopover: function showPopover() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      popovers_showPopover(_objectSpread2(_objectSpread2(_objectSpread2({
        ref: this.$el
      }, this.popover_), opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
    ...
    hidePopover: function hidePopover() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      popovers_hidePopover(_objectSpread2(_objectSpread2(_objectSpread2({
        hideDelay: 10
      }, this.popover_), opts), {}, {
        id: this.datePickerPopoverId
      }));
    ...
    togglePopover: function togglePopover(opts) {
      popovers_togglePopover(_objectSpread2(_objectSpread2(_objectSpread2({
        ref: this.$el
      }, this.popover_), opts), {}, {
        isInteractive: true,
        id: this.datePickerPopoverId
